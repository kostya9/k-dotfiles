...
$komorebiApplicationsLocation = Join-Path $currentDirectory "komorebi/applications.json"
Copy-Item -Path $komorebiApplicationsLocation -Destination "~/applications.json"
